...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center gap-2 bg-yellow-500">
      <div className="mb-5">
        <img src="https://www.mateng.co.in/_next/image?url=%2Fmateng_icon.png&w=640&q=75" alt="" className="w-[250px]" />
      </div>
      <div className="flex flex-col items-center justify-center shadow-md p-10 gap-6 rounded bg-white">
        <h1>Login to your account</h1>
        <div className="flex border-2 border-sky-500 gap-5 rounded-full p-3 items center hover:bg-black hover:text-white" onClick={handleLogin}>
